...
This C-based project renders animated 3D wireframe models using anti-aliased lines, Lambertian lighting, and Bézier-curve-based animation. The output is a series of `.pgm` image frames that can be combined into a GIF or video. The output of the first 2 tasks are converted to .png format.
